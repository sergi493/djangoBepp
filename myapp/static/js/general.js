...
//per a descarregar en pdf les factures/pressupost i altres (necessari)
function getBase64ImageFromUrl(url) {
  return new Promise((resolve, reject) => {
    const img = new Image();
    img.setAttribute('crossOrigin', 'anonymous'); // para evitar problemas CORS si la imagen está en otro dominio
    img.onload = () => {
